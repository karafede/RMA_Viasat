...
for idTerm in idTerminale:
    ...
    query=("SELECT ST_X(ST_Transform(dataraw.geom, 32632)), ST_Y(ST_Transform(dataraw.geom, 32632)), " 
          "CASE WHEN ((DATE (dataraw.timedate + (route_trenta_tris.breaktime_s * ('1 second')::INTERVAL)+('2 hour')::INTERVAL) - DATE(dataraw.timedate+('2 hour')::INTERVAL)=0) " 
          "AND (dataraw.timedate+('2 hour')::INTERVAL)<(date_trunc('day', dataraw.timedate + route_trenta_tris.breaktime_s * ('1 second')::INTERVAL+('2 hour')::INTERVAL) + '03:00:00')) "
          "THEN 1 "
          "WHEN (DATE (dataraw.timedate + (route_trenta_tris.breaktime_s * ('1 second')::INTERVAL)+('2 hour')::INTERVAL) - DATE(dataraw.timedate+('2 hour')::INTERVAL)>0) "
          "AND ((date_trunc('day', dataraw.timedate + route_trenta_tris.breaktime_s * ('1 second')::INTERVAL+('2 hour')::INTERVAL) + '03:00:00')>((dataraw.timedate + (route_trenta_tris.breaktime_s * ('1 second')::INTERVAL)+('2 hour')::INTERVAL))) "
          "THEN ((DATE (dataraw.timedate + (route_trenta_tris.breaktime_s * ('1 second')::INTERVAL)+('2 hour')::INTERVAL) - DATE(dataraw.timedate+('2 hour')::INTERVAL))-1) "
          "ELSE DATE(dataraw.timedate + (route_trenta_tris.breaktime_s * ('1 second')::INTERVAL)+('2 hour')::INTERVAL) - DATE(dataraw.timedate+('2 hour')::INTERVAL) "
          "END as nights "
          "FROM route_trenta_tris "
          "inner join dataraw on dataraw.id=route_trenta_tris.idtrace_d "
          "where route_trenta_tris.idterm="+idTerm+" and dataraw.panel=2 and breaktime_s>4*3600 and "
          "((DATE (dataraw.timedate + (route_trenta_tris.breaktime_s * ('1 second')::INTERVAL)+('2 hour')::INTERVAL) - DATE(dataraw.timedate+('2 hour')::INTERVAL)=0 "
          "AND (dataraw.timedate+('2 hour')::INTERVAL)<(date_trunc('day', dataraw.timedate + route_trenta_tris.breaktime_s * ('1 second')::INTERVAL+('2 hour')::INTERVAL) + '03:00:00')) "
          "OR (DATE (dataraw.timedate + (route_trenta_tris.breaktime_s * ('1 second')::INTERVAL)+('2 hour')::INTERVAL) - DATE(dataraw.timedate+('2 hour')::INTERVAL)>0)) "
    ...
    query=("SELECT  ST_X(ST_Transform(dataraw.geom, 32632)), ST_Y(ST_Transform(dataraw.geom, 32632)), "
          ...
          "AND  EXTRACT(hour from (dataraw.timedate + route_trenta_tris.breaktime_s * ('1 second')::INTERVAL+('2 hour')::INTERVAL))>=3 )) "
          "THEN 1 "
          "WHEN ((DATE (dataraw.timedate + (route_trenta_tris.breaktime_s * ('1 second')::INTERVAL)+('2 hour')::INTERVAL) - DATE(dataraw.timedate+('2 hour')::INTERVAL))>0 " 
          "AND (EXTRACT(hour from(dataraw.timedate+('2 hour')::INTERVAL))>=3 "
          "AND  EXTRACT(hour from (dataraw.timedate + route_trenta_tris.breaktime_s * ('1 second')::INTERVAL+('2 hour')::INTERVAL))<3 )) "
          ...
          "AND (EXTRACT(hour from(dataraw.timedate+('2 hour')::INTERVAL))>=3 "
          "AND  EXTRACT(hour from (dataraw.timedate + route_trenta_tris.breaktime_s * ('1 second')::INTERVAL+('2 hour')::INTERVAL))>=3 )) "
          "THEN (DATE (dataraw.timedate + (route_trenta_tris.breaktime_s * ('1 second')::INTERVAL)+('2 hour')::INTERVAL) - DATE(dataraw.timedate+('2 hour')::INTERVAL))  "
          "WHEN ((DATE (dataraw.timedate + (route_trenta_tris.breaktime_s * ('1 second')::INTERVAL)+('2 hour')::INTERVAL) - DATE(dataraw.timedate+('2 hour')::INTERVAL))>0 "
          "AND (EXTRACT(hour from(dataraw.timedate+('2 hour')::INTERVAL))<3 "
          "AND  EXTRACT(hour from (dataraw.timedate + route_trenta_tris.breaktime_s * ('1 second')::INTERVAL+('2 hour')::INTERVAL))<3 )) "
          "THEN (DATE (dataraw.timedate + (route_trenta_tris.breaktime_s * ('1 second')::INTERVAL)+('2 hour')::INTERVAL) - DATE(dataraw.timedate+('2 hour')::INTERVAL)) "
          ...
          "FROM route_trenta_tris "
          "inner join dataraw on dataraw.id=route_trenta_tris.idtrace_d "
          "where route_trenta_tris.idterm="+idTerm+" and breaktime_s>4*3600 and "
          "( "
          "((DATE (dataraw.timedate + (route_trenta_tris.breaktime_s * ('1 second')::INTERVAL)+('2 hour')::INTERVAL) - DATE(dataraw.timedate+('2 hour')::INTERVAL))=0 "
		  "AND (EXTRACT(hour from(dataraw.timedate+('2 hour')::INTERVAL))<3 "
		  "AND  EXTRACT(hour from (dataraw.timedate + route_trenta_tris.breaktime_s * ('1 second')::INTERVAL+('2 hour')::INTERVAL))>=3 )) "
          "OR "
          "((DATE (dataraw.timedate + (route_trenta_tris.breaktime_s * ('1 second')::INTERVAL)+('2 hour')::INTERVAL) - DATE(dataraw.timedate+('2 hour')::INTERVAL))>1) "
	      "OR "
	      "((DATE (dataraw.timedate + (route_trenta_tris.breaktime_s * ('1 second')::INTERVAL)+('2 hour')::INTERVAL) - DATE(dataraw.timedate+('2 hour')::INTERVAL))=1 "
	      "AND (EXTRACT(hour from(dataraw.timedate+('2 hour')::INTERVAL))>=3 "
	      "AND  EXTRACT(hour from (dataraw.timedate + route_trenta_tris.breaktime_s * ('1 second')::INTERVAL+('2 hour')::INTERVAL))>=3 )) "
